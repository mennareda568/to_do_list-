        ...
        <div class="col-md-10 m-auto">
         <form enctype="multipart/form-data" action="<?php echo e(route('updatepending')); ?>" method="post" >
            <?php echo csrf_field(); ?>
                ...
                <input type="text" name="title" class="form-control mb-4" value="<?php echo e($result->title); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="date" name="date" class="form-control mb-4" value="<?php echo e($result->date); ?>">
